function moon() {
    var e = document.getElementById("ohayou");
    e.innerHTML = "<ruby>おはよう! <rp>(</rp><rt>Ohay&#x14D;!</rt><rp>)</rp></ruby>", e.lang = "jp"
}
var Zepto = function() {
    function e(e) {
    ...
    function o(e) {
        return i(e) && !n(e) && e.__proto__ == Object.prototype
    }
    ...
    function p(e, t) {
        return "number" != typeof t || F[u(e)] ? t : t + "px"
    }

    function d(e) {
        var t, n;
        return z[e] || (t = D.createElement(e), D.body.appendChild(t), n = A(t, "").getPropertyValue("display"), t.parentNode.removeChild(t), "none" == n && (n = "block"), z[e] = n), z[e]
    }

    function h(e) {
        return "children" in e ? L.call(e.children) : T.map(e.childNodes, function(e) {
            return 1 == e.nodeType ? e : void 0
        })
    }

    function v(e, t, n) {
        for (C in t) n && (o(t[C]) || a(t[C])) ? (o(t[C]) && !o(e[C]) && (e[C] = {}), a(t[C]) && !a(e[C]) && (e[C] = []), v(e[C], t[C], n)) : t[C] !== E && (e[C] = t[C])
    }
    ...
    function w(e) {
        var t;
        try {
            return e ? "true" == e || "false" != e && ("null" == e ? null : isNaN(t = Number(e)) ? /^[\[\{]/.test(e) ? T.parseJSON(e) : e : t) : e
        } catch (t) {
            return e
        }
    }
    ...
    function x(e, t) {
        t(e);
        for (var n in e.childNodes) x(e.childNodes[n], t)
    }
    var E, C, T, O, j, N, k = [],
        L = k.slice,
        $ = k.filter,
        ...
        z = {},
        S = {},
        A = D.defaultView.getComputedStyle,
        F = {
            "column-count": 1,
            columns: 1,
            "font-weight": 1,
    ...
    return K.matches = function(e, t) {
        ...
        var r, i = e.parentNode,
            o = !i;
        return o && (i = G).appendChild(e), r = ~K.qsa(i, t).indexOf(e), o && G.removeChild(e), r
    }, j = function(e) {
        ...
        e.replace && (e = e.replace(I, "<$1></$2>")), t === E && (t = _.test(e) && RegExp.$1), t in V || (t = "*");
        var r, i, a = V[t];
        return a.innerHTML = "" + e, i = T.each(L.call(a.childNodes), function() {
            a.removeChild(this)
        }), o(n) && (r = T(i), T.each(n, function(e, t) {
        ...
        if (e) {
            if (t(e)) return T(D).ready(e);
            if (K.isZ(e)) return e;
            var r;
            if (a(e)) r = l(e);
            else if (i(e)) r = [o(e) ? T.extend({}, e) : e], e = null;
            else if (_.test(e)) r = K.fragment(e.trim(), RegExp.$1, n), e = null;
            else {
        ...
        var n;
        return r(e) && X.test(t) ? (n = e.getElementById(RegExp.$1)) ? [n] : [] : 1 !== e.nodeType && 9 !== e.nodeType ? [] : L.call(U.test(t) ? e.getElementsByClassName(RegExp.$1) : H.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t))
    }, T.contains = function(e, t) {
        return e !== t && e.contains(t)
    }, T.type = e, T.isFunction = t, T.isWindow = n, T.isArray = a, T.isPlainObject = o, T.isEmptyObject = function(e) {
        var t;
        for (t in e) return !1;
        return !0
    }, T.inArray = function(e, t, n) {
        return k.indexOf.call(t, e, n)
    }, T.camelCase = j, T.trim = function(e) {
        ...
        ready: function(e) {
            return Y.test(D.readyState) ? e(T) : D.addEventListener("DOMContentLoaded", function() {
                e(T)
            }, !1), this
        },
        get: function(e) {
        ...
        filter: function(e) {
            return t(e) ? this.not(this.not(e)) : T($.call(this, function(t) {
                return K.matches(t, e)
            }))
        },
        add: function(e, t) {
            return T(N(this.concat(T(e, t))))
        },
        is: function(e) {
        ...
        not: function(e) {
            ...
            if (t(e) && e.call !== E) this.each(function(t) {
                ...
                var r = "string" == typeof e ? this.filter(e) : s(e) && t(e.item) ? L.call(e) : T(e);
        ...
        find: function(e) {
            var t = this;
            return "object" == typeof e ? T(e).filter(function() {
                var e = this;
                return k.some.call(t, function(t) {
                    return T.contains(t, e)
                })
            }) : 1 == this.length ? T(K.qsa(this[0], e)) : this.map(function() {
                return K.qsa(this, e)
            })
        },
        closest: function(e, t) {
            var n = this[0],
                i = !1;
            for ("object" == typeof e && (i = T(e)); n && !(i ? i.indexOf(n) >= 0 : K.matches(n, e));) n = n !== t && !r(n) && n.parentNode;
            return T(n)
        },
        parents: function(e) {
        ...
        parent: function(e) {
            return m(N(this.pluck("parentNode")), e)
        },
        children: function(e) {
        ...
        show: function() {
            return this.each(function() {
                "none" == this.style.display && (this.style.display = null), "none" == A(this, "").getPropertyValue("display") && (this.style.display = d(this.nodeName))
            })
        },
        ...
        html: function(e) {
            return e === E ? this.length > 0 ? this[0].innerHTML : null : this.each(function(t) {
                var n = this.innerHTML;
                T(this).empty().append(y(this, e, t, n))
            })
        },
        text: function(e) {
            return e === E ? this.length > 0 ? this[0].textContent : null : this.each(function() {
                this.textContent = e
            })
        },
        attr: function(e, t) {
        ...
        prop: function(e, t) {
            return t === E ? this[0] && this[0][e] : this.each(function(n) {
                this[e] = y(this, t, n, this[e])
            })
        },
        data: function(e, t) {
            var n = this.attr("data-" + u(e), t);
            return null !== n ? w(n) : E
        },
        val: function(e) {
            return e === E ? this[0] && (this[0].multiple ? T(this[0]).find("option").filter(function(e) {
        ...
        css: function(t, n) {
            if (arguments.length < 2 && "string" == typeof t) return this[0] && (this[0].style[j(t)] || A(this[0], "").getPropertyValue(t));
            var r = "";
            if ("string" == e(t)) n || 0 === n ? r = u(t) + ":" + p(t, n) : this.each(function() {
                this.style.removeProperty(u(t))
            });
            else
                for (C in t) t[C] || 0 === t[C] ? r += u(C) + ":" + p(C, t[C]) + ";" : this.each(function() {
        ...
        hasClass: function(e) {
            return k.some.call(this, function(e) {
        ...
        addClass: function(e) {
            return this.each(function(t) {
                ...
                y(this, e, t, n).split(/\s+/g).forEach(function(e) {
                    T(this).hasClass(e) || O.push(e)
                }, this), O.length && b(this, n + (n ? " " : "") + O.join(" "))
            })
        },
        removeClass: function(e) {
            return this.each(function(t) {
                return e === E ? b(this, "") : (O = b(this), y(this, e, t, O).split(/\s+/g).forEach(function(e) {
                    O = O.replace(f(e), " ")
                }), void b(this, O.trim()))
            })
        },
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || D.body; e && !P.test(e.nodeName) && "static" == T(e).css("position");) e = e.offsetParent;
                return e
            })
        }
        ...
        T.fn[e] = function(t) {
            var i, o = this[0],
                a = e.replace(/./, function(e) {
                    return e[0].toUpperCase()
                });
            return t === E ? n(o) ? o["inner" + a] : r(o) ? o.documentElement["offset" + a] : (i = this.offset()) && i[e] : this.each(function(n) {
                (o = T(this)).css(e, y(this, t, n, o[e]()))
            })
        }
        ...
        T.fn[t] = function() {
            ...
            return o.length < 1 ? this : this.each(function(e, t) {
                i = r ? t : t.parentNode, t = 0 == n ? t.nextSibling : 1 == n ? t.firstChild : 2 == n ? t : null, o.forEach(function(e) {
                    if (a) e = e.cloneNode(!0);
                    else if (!i) return T(e).remove();
                    x(i.insertBefore(e, t), function(e) {
    ...
    }), K.Z.prototype = T.fn, K.uniq = N, K.deserializeValue = w, T.zepto = K, T
}();
window.Zepto = Zepto, "$" in window || (window.$ = Zepto),
    function(e) {
        ...
        function l(n, i, l, c, u, f) {
            var d = t(n),
                h = p[d] || (p[d] = []);
            o(i, l, function(t, i) {
                var o = r(t);
                o.fn = i, o.sel = c, o.e in v && (i = function(t) {
                ...
                }, o.i = h.length, h.push(o), n.addEventListener(s(o.e), o.proxy, a(o, f))
            })
        }

        function c(e, r, i, l, c) {
            var u = t(e);
            o(r || "", i, function(t, r) {
                n(e, t, r, l).forEach(function(t) {
                    delete p[u][t.i], e.removeEventListener(s(t.e), t.proxy, a(t, c))
                })
            })
        }
        ...
        function u(t) {
            ...
            for (n in t) g.test(n) || void 0 === t[n] || (r[n] = t[n]);
            return e.each(b, function(e, n) {
                r[e] = function() {
                    return this[n] = m, t[e].apply(t, arguments)
                }, r[n] = y
            }), r
        }
        ...
        h.click = h.mousedown = h.mouseup = h.mousemove = "MouseEvents", e.event = {
            add: l,
            remove: c
        ...
        e.fn.delegate = function(t, n, r) {
            ...
            return ("string" == typeof t || e.isPlainObject(t)) && (t = e.Event(t)), f(t), t.data = n, this.each(function() {
                "dispatchEvent" in this && this.dispatchEvent(t)
            })
        }, e.fn.triggerHandler = function(t, r) {
            var i, o;
            return this.each(function(a, s) {
                (i = u("string" == typeof t ? e.Event(t) : t)).data = r, i.target = s, e.each(n(s, t.type || t), function(e, t) {
    ...
    function() {
        EventEmitter = function() {}, EventEmitter.prototype.on = function(e, t) {
            this._events = this._events || {}, this._events[e] = this._events[e] || [], this._events[e].push(t)
        }, EventEmitter.prototype.off = function(e, t) {
            this.hasOwnProperty("_events") && e in this._events != 0 && this._events[e].splice(this._events[e].indexOf(t), 1)
        }, EventEmitter.prototype.emit = function(e) {
            if (this.hasOwnProperty("_events") && e in this._events != 0)
                for (var t = 0, n = this._events[e].length; n > t; t++) this._events[e][t].apply(this, Array.prototype.slice.call(arguments, 1))
        ...
        var e = {
            get: function() {
                var e = ["B", "KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"],
                    t = Math.floor(Math.log(this.size) / Math.log(1024));
                return (this.size / Math.pow(1024, t)).toFixed(2) + " " + e[t]
            }
        };
        Object.defineProperty(FileList.prototype, "humanSize", e), Object.defineProperty(File.prototype, "humanSize", e);
        var t = {
            get: function() {
                return this.uploadedSize / this.size
            }
        };
        Object.defineProperty(FileList.prototype, "percentUploaded", t), Object.defineProperty(File.prototype, "percentUploaded", t), Object.defineProperty(FileList.prototype, "uploadedSize", {
            get: function() {
                return this.reduce(function(e, t) {
                    return e + (t.uploadedSize || 0)
                }, 0)
            }
        ...
        }), File.revokeURL = function(e) {
            window.URL.revokeObjectURL(e)
        };
        var n = function e(t, n) {
                var r = t;
                for (var i in n) "object" == typeof n[i] ? r[i] = e(t[i], n[i]) : r[i] = n[i];
                return r
            },
            r = function(e, t, r) {
                this.url = e, this.files = t, r = r || {}, this.opts = n({
                    field: "files[]",
                    method: "POST",
                    data: {}
                }, r)
            };
        (r.prototype = Object.create(EventEmitter.prototype)).upload = function(e) {
            e && this.on("uploadcomplete", e);
            var t = this.opts,
                n = this.files,
                r = this,
                i = new FormData;
            ...
            o.open(t.method, this.url, !0), o.upload.addEventListener("loadstart", function(e) {
                for (var t = 0, r = n.length; r > t; t++) n[t].uploadedSize = 0
            }), o.upload.addEventListener("progress", function(e) {
                if (e.lengthComputable) {
                    size = e.loaded;
                    for (var t = 0, i = n.length; i > t; t++) n[t].uploadedSize = Math.min(size, n[t].size), size -= n[t].uploadedSize, size <= 0 && (n.current = n[t], size = 0)
                }
                r.emit("uploadprogress", e, n)
            }, !1), o.upload.addEventListener("loadstart", function(e) {
                r.emit("uploadstart", e)
            }), o.upload.addEventListener("load", function(e) {
                r.emit("uploadcomplete", e)
            }), o.addEventListener("progress", function(e) {
                r.emit("progress", e)
            }), o.addEventListener("load", function(e) {
                r.emit("load", e, o.responseText)
            }), o.send(i)
        }, FileList.prototype.upload = function(e, t) {
            return new r(e, this, t)
        }
    }(),
    function(e) {
        e.hasFileAPI = function() {
            return void 0 !== window.FormData
        }, e.fn.cabinet = function(t) {
            var n = this,
                r = function(e, r, i, o) {
                    n.on(e, function(e) {
                        "click" === r ? t[0].click() : t.trigger(r), i && e.preventDefault(), o && o(e)
                    }, !1)
                };
            (t = e(t))[0].filelist = Object.create(FileList), t.on("change", function(e) {
                this.filelist = e.target.files, n.change()
            }), r("dragenter", "dragenter", !0), r("dragover", "dragover", !0), r("dragleave", "dragleave", !0), r("click", "click", !1), r("drop", "dragleave", !0, function(e) {
                t[0].filelist = e.dataTransfer.files, n.change()
            })
        }
    }($), $(function() {
        var e = $("#upload-input"),
            ...
            n = $("#upload-filelist"),
            r = "";
        $.hasFileAPI() || ($("#no-file-api").show(), t.hide()), t.cabinet(e), t.on("dragenter", function(e) {
            this === e.target && ($(this).addClass("drop"), r = $(this).html(), $(this).html("Drop it here~"))
            ...
            do {
                if (node === this) {
                    $(this).removeClass("drop"), $(this).html(r);
                    break
                }
            } while (node = node.parentNode)
        });
        var i = function(e) {
                var t = e.attr("data-max-size") || "100MiB",
                    n = parseInt(/([0-9,]+).*/.exec(t)[1].replace(",", "")),
                    r = /(?:([KMGTPEZY])(i)?B|([BKMGTPEZY]))/.exec(t) || ["B", "", ""];
                return n * Math.pow("i" === r[2] ? 1024 : 1e3, "BKMGTPEZY".indexOf(r[1]))
            }(e),
            o = function(e, t, n) {
                var r = $("<li class=file>"),
                    i = $("<span class=file-name>"),
                    o = $('<div class="file-progress progress-outer">'),
                    a = $("<span class=file-size>"),
                    s = $("<span class=file-url>");
                return r.addClass(n || ""), $("<div class=progress-inner>").appendTo(o), r.attr("data-filename", escape(e)), i.text(e), a.text(t), r.append(i, o, a, s), r
            };
        t.on("change", function(t) {
            n.empty().removeClass("error completed");
            var r = e[0].filelist;
            r.forEach(function(e) {
                if (-1 !== e.name.indexOf(".exe", e.name.length - ".exe".length)) {
                    var t = o("", r.humanSize, "total");
                    return t.appendTo(n), n.addClass("error"), void $(".file-name", t).text("Uploading .exe files is blocked due to abuse.")
                }
                o(e.name, e.humanSize).appendTo(n)
            });
            var a = o("", r.humanSize, "total");
            if (a.appendTo(n), r.size > i) return n.addClass("error"), void $(".file-name", a).text("onii-chan it's too big");
            var s = r.upload("upload.php"),
                l = function(e, t) {
                    var n = {};
                    e.forEach(function(r) {
                        ++n[r.name] || (n[r.name] = 0);
                        var i = $($('li[data-filename="' + escape(r.name) + '"]')[n[r.name] || 0]);
                        t.call(i, i, r, e)
                    })
                },
                c = $(".file-name", a);
            s.on("uploadprogress", function(e, t) {
                l(t, function(e, t, n) {
                    $(".progress-inner", e).width(100 * t.percentUploaded + "%")
                }), $(".progress-inner", a).width(100 * t.percentUploaded + "%")
            }), s.on("uploadcomplete", function(e) {
                $(".progress-inner").width("100%"), c.text("Grabbing URLs...")
            }), s.on("load", function(e, t) {
                var r = 0;
                switch (e.target.status) {
                    case 200:
                        if (!(t = JSON.parse(t)).success) {
                            n.addClass("error"), $(".file-name", a).text("Something went wrong; try again later.");
                            break
                        }
                        l(t.files, function(e, t, n) {
                            var i = $("<a>");
                            i.attr("href", "https://x.suicide.moe/" + t.url).attr("target", "_BLANK").text("x.suicide.moe/" + t.url), $(".file-url", e).append(i);
                            var o = "<button id='copycat" + r + "' class='copycat ion-link' data-clipboard-text='https://x.suicide.moe/" + t.url + "'></button>";
                            $(".file-url", e).append(o);
                            var a = new ZeroClipboard(document.getElementById("copycat" + r));
                            a.on("ready", function(e) {
                                a.on("aftercopy", function(e) {})
                            }), r++
                        }), n.addClass("completed"), c.text("Done!");
                        break;
                    case 413:
                        n.addClass("error completed"), c.html($("<div/>").html("onii-chan, y-your upload is t-too big&hellip;").text());
                        break;
                    default:
                        n.addClass("error completed"), c.text("Something went wrong; try again later.")
                }
            }), s.upload()
        })
    }),
    function(e, t) {
        ...
        var n, r, i, o = e,
            ...
            j = function() {
                var e, n, r, i, o, a = O(arguments),
                    s = a[0] || {};
                for (e = 1, n = a.length; n > e; e++)
                    if (null != (r = a[e]))
                        for (i in r) E.call(r, i) && (s[i], o = r[i], s !== o && o !== t && (s[i] = o));
                return s
            },
            N = function(e) {
                var t, n, r, i;
                if ("object" != typeof e || null == e || "number" == typeof e.nodeType) t = e;
                    ...
                    for (t = [], n = 0, r = e.length; r > n; n++) E.call(e, n) && (t[n] = N(e[n]));
                else {
                    t = {};
                    for (i in e) E.call(e, i) && (t[i] = N(e[i]))
                }
                return t
            },
            k = function(e, t) {
            ...
            $ = function(e) {
                if (e)
                    for (var t in e) E.call(e, t) && delete e[t];
                return e
            },
            D = function(e, t) {
            ...
            S = function(e) {
                var t, n;
                return "string" == typeof e && e && (n = e.match(/^(?:|[^:@]*@|.+\)@(?=https[s]?|file)|.+?\s+(?: at |@)(?:[^:\(]+ )*[\(]?)((?:http[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/), n && n[1] ? t = n[1] : (n = e.match(/\)@((?:https[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/)) && n[1] && (t = n[1])), t
            },
            A = function() {
                var e, t;
                try {
            ...
            F = function() {
                ...
                return "loading" === a.readyState && (e = n[n.length - 1].src) ? e : (e = A()) ? e : t
            },
            _ = function() {
                var e, n, r, i = a.getElementsByTagName("script");
                for (e = i.length; e--;) {
                    if (!(r = i[e].src)) {
                        n = null;
                        break
            ...
            H = ["flash-disabled", "flash-outdated", "flash-sandboxed", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"],
            q = new RegExp("^flash-(" + H.map(function(e) {
                return e.replace(/^flash-/, "")
            }).join("|") + ")$"),
            J = new RegExp("^flash-(" + H.slice(1).map(function(e) {
                return e.replace(/^flash-/, "")
            }).join("|") + ")$"),
            K = {
                swfPath: function() {
                    return (z(F()) || _() || "") + "ZeroClipboard.swf"
                }(),
            ...
            G = function(e) {
                if ("object" == typeof e && null !== e)
                    for (var t in e)
                        if (E.call(e, t))
                            if (/^(?:forceHandCursor|title|zIndex|bubbleEvents)$/.test(t)) K[t] = e[t];
                ...
                return "string" == typeof e && e ? E.call(K, e) ? K[e] : void 0 : N(K)
            },
            W = function() {
                return Ye(), {
                    browser: k(s, ["userAgent", "platform", "appName"]),
                    flash: L(P, ["bridge"]),
                    zeroclipboard: {
                        version: Xe.version,
                        config: Xe.config()
            ...
            ee = function(e, r) {
                ...
                else if ("object" == typeof e && e && void 0 === r)
                    for (i in e) E.call(e, i) && "string" == typeof i && i && "function" == typeof e[i] && Xe.on(i, e[i]);
                if (a && a.length) {
                    for (i = 0, o = a.length; o > i; i++) e = a[i].replace(/^on/, ""), s[e] = !0, M[e] || (M[e] = []), M[e].push(r);
                    if (s.ready && P.ready && Xe.emit({
                            type: "ready"
                        }), s.error) {
                        for (i = 0, o = H.length; o > i; i++)
                            if (!0 === P[H[i].replace(/^flash-/, "")]) {
                                Xe.emit({
                                    type: "error",
                                    name: H[i]
                                });
            ...
            te = function(e, t) {
                var n, r, i, o, a;
                if (0 === arguments.length) o = w(M);
                else if ("string" == typeof e && e) o = e.split(/\s+/);
                else if ("object" == typeof e && e && void 0 === t)
                    for (n in e) E.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && Xe.off(n, e[n]);
                if (o && o.length)
                    for (n = 0, r = o.length; r > n; n++)
                        if (e = o[n].toLowerCase().replace(/^on/, ""), (a = M[e]) && a.length)
                            if (t)
            ...
            ne = function(e) {
                return "string" == typeof e && e ? N(M[e]) || null : N(M)
            },
            re = function(e) {
                var t, n, r;
                return e = de(e), e && !we(e) ? "ready" === e.type && !0 === P.overdue ? Xe.emit({
                    type: "error",
                    name: "flash-overdue"
                }) : (t = j({}, e), ge.call(this, t), "copy" === e.type && (r = ke(B), n = r.data, R = r.formatMap), n) : void 0
            },
            ie = function() {
                var e = P.sandboxed;
                if (Ye(), "boolean" != typeof P.ready && (P.ready = !1), P.sandboxed !== e && !0 === P.sandboxed) P.ready = !1, Xe.emit({
                    type: "error",
                    name: "flash-sandboxed"
                });
                else if (!Xe.isFlashUnusable() && null === P.bridge) {
                    var t = K.flashLoadTimeout;
                    "number" == typeof t && t >= 0 && (V = l(function() {
                        "boolean" != typeof P.deactivated && (P.deactivated = !0), !0 === P.deactivated && Xe.emit({
                            type: "error",
            ...
            oe = function() {
                Xe.clearData(), Xe.blur(), Xe.emit("destroy"), Ne(), Xe.off()
            },
            ae = function(e, t) {
                var n;
                ...
                for (var r in n) "string" == typeof r && r && E.call(n, r) && "string" == typeof n[r] && n[r] && (B[r] = n[r])
            },
            se = function(e) {
                void 0 === e ? ($(B), R = null) : "string" == typeof e && E.call(B, e) && delete B[e]
            },
            le = function(e) {
                return void 0 === e ? N(B) : "string" == typeof e && E.call(B, e) ? B[e] : void 0
            },
            ce = function(e) {
                if (e && 1 === e.nodeType) {
                    r && (_e(r, K.activeClass), r !== e && _e(r, K.hoverClass)), r = e, Fe(e, K.hoverClass);
                    var t = e.getAttribute("title") || K.title;
                    if ("string" == typeof t && t) {
                        var n = Oe(P.bridge);
                        n && n.setAttribute("title", t)
                    }
                    var i = !0 === K.forceHandCursor || "pointer" === Ie(e, "cursor");
                    Re(i), Be()
                }
            },
            ue = function() {
                var e = Oe(P.bridge);
                e && (e.removeAttribute("title"), e.style.left = "0px", e.style.top = "-9999px", e.style.width = "1px", e.style.height = "1px"), r && (_e(r, K.hoverClass), _e(r, K.activeClass), r = null)
            },
            fe = function() {
                return r || null
            },
            ...
            de = function(e) {
                ...
                if ("string" == typeof e && e ? (t = e, e = {}) : "object" == typeof e && e && "string" == typeof e.type && e.type && (t = e.type), t) {
                    t = t.toLowerCase(), !e.target && (/^(copy|aftercopy|_click)$/.test(t) || "error" === t && "clipboard-error" === e.name) && (e.target = i), j(e, {
                        type: t,
                    ...
                    var n = U[e.type];
                    return "error" === e.type && e.name && n && (n = n[e.name]), n && (e.message = n), "ready" === e.type && j(e, {
                        target: null,
                        version: P.version
                    }), "error" === e.type && (q.test(e.name) && j(e, {
                        target: null,
                        minimumVersion: Z
                    }), J.test(e.name) && j(e, {
                        version: P.version
                    ...
                    }), "aftercopy" === e.type && (e = Le(e, R)), e.target && !e.relatedTarget && (e.relatedTarget = he(e.target)), ve(e)
                }
            },
            he = function(e) {
            ...
            ve = function(e) {
                if (e && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) {
                    ...
                    delete e._stageX, delete e._stageY, j(e, {
                        srcElement: n,
                        fromElement: r,
                        toElement: i,
                        screenX: m,
            ...
            ge = function(e) {
                if ("object" == typeof e && e && e.type) {
                    ...
                    if (i && i.length) {
                        ...
                        for (a = 0, s = i.length; s > a; a++) l = i[a], c = f, "string" == typeof l && "function" == typeof o[l] && (l = o[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent), "function" == typeof l && (u = j({}, e), ye(l, c, [u], t))
                    }
                    return this
                }
            },
            ...
            we = function(e) {
                ...
                switch (delete e._source, e.type) {
                    case "error":
                        var a = "flash-sandboxed" === e.name || be(e);
                        "boolean" == typeof a && (P.sandboxed = a), -1 !== H.indexOf(e.name) ? j(P, {
                            ...
                            ready: !1
                        }) : "version-mismatch" === e.name && (n = e.swfVersion, j(P, {
                            disabled: !1,
                            outdated: !1,
                            unavailable: !1,
                            degraded: !1,
                    ...
                    case "copy":
                        ...
                        break;
                    case "aftercopy":
                        xe(e), Xe.clearData(), t && t !== Ae() && t.focus && t.focus();
                        break;
                    case "_mouseover":
                        Xe.focus(t), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !D(e.relatedTarget, t) && Ee(j({}, e, {
                            type: "mouseenter",
                            bubbles: !1,
                            cancelable: !1
                        })), Ee(j({}, e, {
                        ...
                        break;
                    case "_mouseout":
                        Xe.blur(), !0 === K.bubbleEvents && o && (t && t !== e.relatedTarget && !D(e.relatedTarget, t) && Ee(j({}, e, {
                            type: "mouseleave",
                            bubbles: !1,
                            cancelable: !1
                        })), Ee(j({}, e, {
                        ...
                        break;
                    case "_mousedown":
                        Fe(t, K.activeClass), !0 === K.bubbleEvents && o && Ee(j({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mouseup":
                        _e(t, K.activeClass), !0 === K.bubbleEvents && o && Ee(j({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_click":
                        i = null, !0 === K.bubbleEvents && o && Ee(j({}, e, {
                            type: e.type.slice(1)
                        }));
                        break;
                    case "_mousemove":
                        !0 === K.bubbleEvents && o && Ee(j({}, e, {
                            type: e.type.slice(1)
                        }))
                }
            ...
            Ce = function() {
                ...
                if ("number" == typeof e && e >= 0) {
                    ...
                    Y = u(function() {
                        ...
                        Ze(e) && (Me(), P.deactivated = null, Xe.emit({
                            type: "error",
                            name: "swf-not-found"
                        }))
                    }, t)
            ...
            je = function() {
                var e, t = P.bridge,
                    n = Oe(t);
                if (!t) {
                    var r = Se(o.location.host, K),
                        i = "never" === r ? "none" : "all",
                        s = De(j({
                            jsVersion: Xe.version
                        }, K)),
                        l = K.swfPath + $e(K.swfPath, K);
                    n = Te();
                ...
                return t || ((t = a[K.swfObjectId]) && (e = t.length) && (t = t[e - 1]), !t && n && (t = n.firstChild)), P.bridge = t || null, t
            },
            Ne = function() {
                var e = P.bridge;
                if (e) {
                    var r = Oe(e);
                    r && ("activex" === P.pluginType && "readyState" in e ? (e.style.display = "none", function t() {
                        if (4 === e.readyState) {
            ...
            ke = function(e) {
                ...
                if ("object" == typeof e && e) {
                    for (var r in e)
                        if (r && E.call(e, r) && "string" == typeof e[r] && e[r]) switch (r.toLowerCase()) {
                            case "text/plain":
                            case "text":
                            case "air:text":
                            case "flash:text":
            ...
            Le = function(e, t) {
                ...
                for (var r in e)
                    if (E.call(e, r))
                        if ("errors" === r) {
                            n[r] = e[r] ? e[r].slice() : [];
                            for (var i = 0, o = n[r].length; o > i; i++) n[r][i].format = t[n[r][i].format]
                        } else if ("success" !== r && "data" !== r) n[r] = e[r];
                else {
                    n[r] = {};
                    var a = e[r];
                    for (var s in a) s && E.call(a, s) && E.call(t, s) && (n[r][t[s]] = a[s])
                }
                return n
            },
            $e = function(e, t) {
            ...
            De = function(e) {
                ...
                if (e.trustedDomains && ("string" == typeof e.trustedDomains ? i = [e.trustedDomains] : "object" == typeof e.trustedDomains && "length" in e.trustedDomains && (i = e.trustedDomains)), i && i.length)
                    for (t = 0, n = i.length; n > t; t++)
                        if (E.call(i, t) && i[t] && "string" == typeof i[t]) {
                            if (!(r = ze(i[t]))) continue;
                            if ("*" === r) {
                                s.length = 0, s.push(r);
                                break
                            }
                ...
                return s.length && (a += "trustedOrigins=" + d(s.join(","))), !0 === e.forceEnhancedClipboard && (a += (a ? "&" : "") + "forceEnhancedClipboard=true"), "string" == typeof e.swfObjectId && e.swfObjectId && (a += (a ? "&" : "") + "swfObjectId=" + d(e.swfObjectId)), "string" == typeof e.jsVersion && e.jsVersion && (a += (a ? "&" : "") + "jsVersion=" + d(e.jsVersion)), a
            },
            ze = function(e) {
            ...
            Fe = function(e, t) {
                ...
                if ("string" == typeof t && t && (o = t.split(/\s+/)), e && 1 === e.nodeType && o.length > 0)
                    if (e.classList)
                        for (n = 0, r = o.length; r > n; n++) e.classList.add(o[n]);
                    else if (e.hasOwnProperty("className")) {
                    for (i = " " + e.className + " ", n = 0, r = o.length; r > n; n++) - 1 === i.indexOf(" " + o[n] + " ") && (i += o[n] + " ");
            ...
            _e = function(e, t) {
                ...
                if ("string" == typeof t && t && (o = t.split(/\s+/)), e && 1 === e.nodeType && o.length > 0)
                    if (e.classList && e.classList.length > 0)
                        for (n = 0, r = o.length; r > n; n++) e.classList.remove(o[n]);
                    else if (e.className) {
                    for (i = (" " + e.className + " ").replace(/[\r\n\t]/g, " "), n = 0, r = o.length; r > n; n++) i = i.replace(" " + o[n] + " ", " ");
                    e.className = i.replace(/^\s+|\s+$/g, "")
                }
                return e
            },
            ...
            Pe = function(e) {
                ...
                if (e.getBoundingClientRect) {
                    var n = e.getBoundingClientRect(),
                        ...
                        c = 0,
                        u = 0;
                    if ("relative" === Ie(a.body, "position")) {
                        var f = a.body.getBoundingClientRect(),
                            p = a.documentElement.getBoundingClientRect();
                        c = f.left - p.left || 0, u = f.top - p.top || 0
                    }
            ...
            Re = function(e) {
                !0 === P.ready && (P.bridge && "function" == typeof P.bridge.setHandCursor ? P.bridge.setHandCursor(e) : P.ready = !1)
            },
            Ve = function(e) {
                if (/^(?:auto|inherit)$/.test(e)) return e;
                var t;
                return "number" != typeof e || g(e) ? "string" == typeof e && (t = Ve(m(e, 10))) : t = e, "number" == typeof t ? t : "auto"
            },
            Ye = function(t) {
                var n, r, i, o = P.sandboxed,
                    a = null;
                if (t = !0 === t, !1 === I) a = !1;
                else {
                    try {
                ...
                return P.sandboxed = a, o === a || t || Ue(h), a
            },
            Ue = function(e) {
                function t(e) {
                    var t = e.match(/[\d]+/g);
                ...
                else if (s.mimeTypes && s.mimeTypes.length) a = s.mimeTypes["application/x-shockwave-flash"], i = a && a.enabledPlugin, r(i);
                else if (void 0 !== e) {
                    c = !0;
                    try {
                ...
                P.disabled = !0 !== l, P.outdated = f && y(f) < y(Z), P.version = f || "0.0.0", P.pluginType = u ? "pepper" : c ? "activex" : l ? "netscape" : "unknown"
            };
        Ue(h), Ye(!0);
        var Xe = function() {
        ...
        x(Xe, "version", {
            ...
            return G.apply(this, O(arguments))
        }, Xe.state = function() {
            return W.apply(this, O(arguments))
        }, Xe.isFlashUnusable = function() {
            return Q.apply(this, O(arguments))
        }, Xe.on = function() {
        ...
        var We = function(e) {
            ...
            Qe = function(e, r) {
                ...
                if ("string" == typeof e && e) a = e.toLowerCase().split(/\s+/);
                    ...
                    for (i in e) E.call(e, i) && "string" == typeof i && i && "function" == typeof e[i] && this.on(i, e[i]);
                if (a && a.length) {
                    for (i = 0, o = a.length; o > i; i++) e = a[i].replace(/^on/, ""), s[e] = !0, c[e] || (c[e] = []), c[e].push(r);
                    if (s.ready && P.ready && this.emit({
                            type: "ready",
                            client: this
                        }), s.error) {
                        for (i = 0, o = H.length; o > i; i++)
                            if (P[H[i].replace(/^flash-/, "")]) {
                                this.emit({
                                    type: "error",
                                    name: H[i],
                                    client: this
            ...
            et = function(e, t) {
                var n, r, i, o, a, s = qe[this.id],
                    l = s && s.handlers;
                if (!l) return this;
                if (0 === arguments.length) o = w(l);
                else if ("string" == typeof e && e) o = e.split(/\s+/);
                else if ("object" == typeof e && e && void 0 === t)
                    for (n in e) E.call(e, n) && "string" == typeof n && n && "function" == typeof e[n] && this.off(n, e[n]);
                if (o && o.length)
                    for (n = 0, r = o.length; r > n; n++)
            ...
            tt = function(e) {
                ...
                return n && (t = "string" == typeof e && e ? n[e] ? n[e].slice(0) : [] : N(n)), t
            },
            nt = function(e) {
                if (st.call(this, e)) {
                    "object" == typeof e && e && "string" == typeof e.type && e.type && (e = j({}, e));
                    var t = j({}, de(e), {
                        client: this
                    });
                    lt.call(this, t)
            ...
            rt = function(e) {
                ...
                for (var t = 0; t < e.length; t++)
                    if (E.call(e, t) && e[t] && 1 === e[t].nodeType) {
                        e[t].zcClippingId ? -1 === Ke[e[t].zcClippingId].indexOf(this.id) && Ke[e[t].zcClippingId].push(this.id) : (e[t].zcClippingId = "zcClippingId_" + Je++, Ke[e[t].zcClippingId] = [this.id], !0 === K.autoActivate && ut(e[t]));
            ...
            it = function(e) {
                var t = qe[this.id];
                if (!t) return this;
                for (var n, r = t.elements, i = (e = void 0 === e ? r.slice(0) : ct(e)).length; i--;)
                    if (E.call(e, i) && e[i] && 1 === e[i].nodeType) {
                        for (n = 0; - 1 !== (n = r.indexOf(e[i], n));) r.splice(n, 1);
                        var o = Ke[e[i].zcClippingId];
                        if (o) {
                            for (n = 0; - 1 !== (n = o.indexOf(this.id, n));) o.splice(n, 1);
                            0 === o.length && (!0 === K.autoActivate && ft(e[i]), delete e[i].zcClippingId)
                        }
                    }
                return this
            },
            ...
            lt = function(e) {
                ...
                if ("object" == typeof e && e && e.type && t) {
                    var n = me(e),
                        ...
                        a = r.concat(i);
                    if (a && a.length) {
                        var s, l, c, u, f, p = this;
                        for (s = 0, l = a.length; l > s; s++) c = a[s], u = p, "string" == typeof c && "function" == typeof o[c] && (c = o[c]), "object" == typeof c && c && "function" == typeof c.handleEvent && (u = c, c = c.handleEvent), "function" == typeof c && (f = j({}, e), ye(c, u, [f], n))
                    }
                }
            },
            ct = function(e) {
            ...
            ut = function(e) {
                if (e && 1 === e.nodeType) {
                    ...
                    e.addEventListener("mouseover", n, !1), e.addEventListener("mouseout", t, !1), e.addEventListener("mouseenter", t, !1), e.addEventListener("mouseleave", t, !1), e.addEventListener("mousemove", t, !1), Ge[e.zcClippingId] = {
                        mouseover: n,
                        mouseout: t,
                        mouseenter: t,
                        mouseleave: t,
            ...
            ft = function(e) {
                if (e && 1 === e.nodeType) {
                    ...
                    if ("object" == typeof t && t) {
                        for (var n, r, i = ["move", "leave", "enter", "out", "over"], o = 0, a = i.length; a > o; o++) n = "mouse" + i[o], "function" == typeof(r = t[n]) && e.removeEventListener(n, r, !1);
                        delete Ge[e.zcClippingId]
                    }
                }
            };
        Xe._createClient = function() {
            We.apply(this, O(arguments))
        }, Xe.prototype.on = function() {
            return Qe.apply(this, O(arguments))
        }, Xe.prototype.off = function() {
            return et.apply(this, O(arguments))
        }, Xe.prototype.handlers = function() {
            return tt.apply(this, O(arguments))
